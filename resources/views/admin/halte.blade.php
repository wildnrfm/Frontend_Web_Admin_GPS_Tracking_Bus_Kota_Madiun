  ...
  <div class="modal" style="max-width:760px; border-radius:16px; overflow:hidden;">
    <div class="modal-header" style="background:#f8faf9; border-bottom:1px solid #eef2f0; padding:18px 24px;">
      <div style="display:flex; align-items:center; gap:10px;">
        ...
        <div>
          <div class="modal-title" id="halte-modal-title" style="font-weight:700; font-size:16px; color:var(--c-text-dark); margin:0;">Tambah Halte</div>
          <div style="font-size:11px; color:var(--c-text-grey); margin-top:2px;">Tentukan koordinat halte pada peta di sebelah kanan</div>
        </div>
      </div>
    ...
    <div class="modal-footer" style="background:#f8faf9; border-top:1px solid #eef2f0; padding:16px 24px; display:flex; justify-content:flex-end; gap:12px;">
      ...
      <button class="btn btn-primary btn-sm" onclick="saveHalte()" style="border-radius:8px;">Simpan</button>
    </div>
  </div>
</div>
